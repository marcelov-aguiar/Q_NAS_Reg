...
- Essa é a versão original do train antes que as modificações fossem feitas.
...
def fitness_calculation(id_num:str, params:Dict[str, Any], 
    ...
    if "dataset_type" in params and params["dataset_type"] == "multihead":
        ...
        model_net = model.MultiHeadNetworkGraph(num_classes=dataset_info['num_classes'], 
                                                ...
                                                num_lstm_cells_1=params['num_lstm_cells'][0],
                                                num_lstm_cells_2=params['num_lstm_cells'][1])
    ...
    criterion = RMSELoss() if params['task'] == "regression" else nn.CrossEntropyLoss()
